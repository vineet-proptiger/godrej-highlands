        ...
        <div className="w-full lg:w-7/12 pr-0 lg:pr-8">
          <div className="inner-section" data-aos="fade-up" data-aos-duration="1000">
            ...
            <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" style={{
              ...
              Godrej Green Terraces is a recently launched residential cluster at Godrej The Highlands in the sprawling township of Godrej City in Panvel. This artistic landmark comprises 2 BHK and 3 BHK spacious residences with extensive decks offering verdant views of the surrounding greenery and hills. It also features an exclusive signature collection of palatial 3 BHK apartments
              {!isExpanded ? (
                <>
                  <span>... </span>
                  <span
                ...
                <>
                  <span>. Moreover, AeroPhase is a newly launched cluster near this landmark. These hillside apartments are designed with elegant interiors, smart layouts, branded fitments and high-quality finishings. The apartments offer maximum space utilisation and no clutter. It presents a range of lifestyle amenities like a gymnasium, clubhouse, chlorine-free swimming pool, 9-hole golf course, basketball court, shopping plaza, kids&apos; play area, landscaped garden, office spaces, etc. </span>
                  <span
            ...
            <p className="boldp" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="150" style={{ fontSize: '15px', fontFamily: '"Poppins", sans-serif', fontWeight: '600', color: '#333', marginBottom: '28px' }}>
              Register Your Interest Today — Avail 20:80 Subvention Plan | Book With ₹50,000 As EOI &amp; Save ₹7L To ₹10L!
            </p>
