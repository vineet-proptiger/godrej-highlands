  ...
  const highlightItems = [
    {
      ...
      title: '145-Acre Township',
      desc: 'Sprawling Godrej City with Hill & Greenery Views',
    },
    {
      icon: <GraduationCap size={32} color="#fff" strokeWidth={1.75} />,
      title: 'Live. Work. Play.',
      desc: 'Shopping Plaza, Office Spaces & Daily Conveniences',
    },
    {
      icon: <Server size={32} color="#fff" strokeWidth={1.75} />,
      title: 'G + 38 Storey Towers',
      desc: 'Extensive Decks, Smart Layouts & Branded Fitments',
    },
    {
      icon: <HeartPulse size={32} color="#fff" strokeWidth={1.75} />,
      title: 'World-Class Leisure',
      desc: '9-Hole Golf Course & Chlorine-Free Swimming Pool',
    },
    {
      icon: <Landmark size={32} color="#fff" strokeWidth={1.75} />,
      title: 'A Landmark Community',
      desc: "Panvel's Premier 145-Acre Godrej Township",
    },
    {
      icon: <HeartHandshake size={32} color="#fff" strokeWidth={1.75} />,
      title: 'Exclusive Clusters',
      desc: 'Recently Launched Green Terraces & AeroPhase',
    },
  ]
