    ...
    <div className="relative z-10">
      <div className="max-w-[860px] mx-auto px-2 sm:px-6 pt-14 pb-8 text-center">
        ...
        <p style={{ fontSize: '15px', color: '#fff', fontFamily: 'var(--font-poppins), sans-serif', lineHeight: 1.8, marginBottom: '24px', textAlign: 'justify' }}
          ...
          Godrej Properties presents Godrej City Panvel The Highlands, Navi Mumbai&apos;s premier luxury integrated township offering spacious 2 &amp; 3 BHK hillside apartments across a sprawling 145-acre development. Thoughtfully curated with an attractive 20:80 subvention payment plan structure, world-class lifestyle amenities including a 9-hole golf course and chlorine-free leisure pool, lively retail plaza, state-of-the-art office spaces, and expansive greenery — Godrej City Panvel The Highlands perfectly exemplifies modern township living for an unmatched lifestyle.
        </p>
        ...
        <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.05)', padding: '10px 24px', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          <strong style={{ fontFamily: F_JOST, fontSize: '15px', color: '#fff', letterSpacing: '0.04em' }}>P52000056268</strong>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4 py-4 px-6 border-t border-[#222] text-center sm:text-left max-w-[1200px] mx-auto">
        <p style={{ fontSize: '13px', color: '#888', fontFamily: F_SANS }}>
          &copy; 2026 Godrej City Panvel The Highlands. All rights reserved.
        </p>
