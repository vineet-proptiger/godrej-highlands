    ...
    <section className="hero-container">
      ...
      <div className="hero-slider-wrapper hidden md:grid">
        {slides.map((slide, index) => (
          ...
          >
            <Image
              src={slide.img}
              alt={`Godrej City Panvel The Highlands Banner ${index + 1}`}
              width={1920}
              height={800}
      ...
      <div className="block md:hidden relative w-full bg-[#0F172A]">
        <Image
          ...
          alt="Godrej City Panvel The Highlands Mobile Banner"
          width={1000}
          height={1000}
      ...
      <div className="hero-content">
        ...
        <h1 className="hero-title">
          GODREJ CITY PANVEL THE HIGHLANDS
        </h1>

        {/* Subtitle */}
        <p className="hero-subtitle">
          <span style={{ fontSize: '0.9em', fontWeight: 600, textTransform: 'none', color: '#fff' }}>At Panvel By Godrej Properties</span>
        </p>
        
        {/* Bullet Points */}
        <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            '145 Acres of Sprawling Godrej City Township',
            'G + 38 Storey Towers with Extensive Decks & Verdant Hills Views',
            'Recently Launched Godrej Green Terraces & AeroPhase Clusters',
            'Hillside 2 & 3 BHK Spacious Residences with Branded Fitments',
            '9-Hole Golf Course, Clubhouse, Chlorine-Free Pool & Shopping Plaza'
          ].map((text, i) => (
